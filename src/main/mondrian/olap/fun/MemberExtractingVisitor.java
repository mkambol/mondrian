...
public class MemberExtractingVisitor extends MdxVisitorImpl {
     ...
     */
    private final static String[] unsafeFuncNames = new String[]
    ...
    private final static List<String> blacklist = Collections.unmodifiableList(
        Arrays.asList(unsafeFuncNames));

    public MemberExtractingVisitor(Set<Member> memberSet, ResolvedFunCall call,
